<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container-fluid">
        ...
        <li class="nav navbar-nav navbar-left" style="margin-top: 10px; margin-right: 1px; margin-left: 1px;">
            <form class="form-inline" action="/search/threads" method="get">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="/barang-di-jual">jual beli</a></li>
                <!-- Authentication Links -->
                @if (Auth::guest())
                    <li><a href="{{ url('/login') }}">login</a></li>
                    <li><a href="{{ url('/register') }}">register</a></li>
                @else
                    <li><a href="/barang-di-jual/create">jual barang</a></li>
                    <li><a href="/threads/create">thread di forum</a></li>
                    <li><a href="/">home</a></li>
                    ...
                    <li>
                        <a href="/{{Auth::user()->name}}" style="margin-top: -10px; margin-bottom: -10px;">
                            <img src=" {{Auth::user()->getAvatar()}} " alt="" class="media-object img-circle" onerror="this.style.display='none'">

<div class="marketing">
  ...
  @foreach($jualcomments as $jualcomment)
    <div class="col-md-4">
      ...
      <div class="fb-like" data-href="http://fidawa.com/fjb/{{$jualcomment->title}}" data-width="250" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>

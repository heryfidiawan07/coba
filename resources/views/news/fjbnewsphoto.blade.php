<div class="marketing">
  ...
  @foreach($jualsphotos as $jualsphoto)
    <div class="col-md-3">
      ...
      <div class="fb-like" data-href="http://fidawa.com/fjb/{{$jualsphoto->title}}" data-width="250" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>

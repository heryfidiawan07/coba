<div class="marketing">
  @if($newcomments->count())
    <h4 class="text-center">new comments from threads</h4>
    <hr>
  @endif
    ...
    <div class="col-md-4">
      <div class="media">
        <a href="/{{$newcomment->user->getName()}}" class="pull-left">
            <img src=" {{$newcomment->user->getAvatar()}} " alt="{{$newcomment->user->getName()}}" class="media-object img-circle" onerror="this.style.display='none'">
            <img src="{{asset('/img/users/'.$newcomment->user->getAvatar() )}}" alt="{{$newcomment->user->getName()}}" class="media-object img-circle" onerror="this.style.display='none'">
        </a>        
      ...
      <div class="panel-footer">
        <div class="media">
          <a href="/{{$newcomment->getComment()->user->getName()}}" class="pull-left">
              <img src=" {{$newcomment->getComment()->user->getAvatar()}} " alt="{{$newcomment->getComment()->user->getName()}}" class="media-object img-circle" onerror="this.style.display='none'">
              <img src="{{asset('/img/users/'.$newcomment->user->getAvatar() )}}" alt="{{$newcomment->getComment()->user->getName()}}" class="media-object img-circle" onerror="this.style.display='none'">
          </a>        

<div class="marketing">
  ...
  @foreach($topjuals as $topjual)
    <div class="col-md-3">
      ...
      <hr>
      <div class="fb-like" data-href="http://fidawa.com/fjb/{{$topjual->title}}" data-width="250" data-layout="button_count" data-action="recommend" data-size="small" data-show-faces="true" data-share="true"></div>

<div class="marketing">
  ...
  @foreach($topjuals as $topjual)
    <div class="col-md-3">
      ...
      <hr>
      <div class="fb-like" data-href="http://www.fidawa.com/fjb/{{$topjual->title}}" data-width="250" data-height="250" data-colorscheme="light" data-layout="standard" data-action="like" data-show-faces="true" data-send="true"></div>

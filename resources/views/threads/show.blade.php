        ...
        <div class="panel panel-default" style="padding: 10px 10px;">
            <div class="media">
                <div class="media">
                    ...
                    <hr>
                    <div class="fb-like" data-href="http://www.fidawa.com/threads/{{$thread->title}}" data-width="250" data-height="250" data-colorscheme="light" data-layout="standard" data-action="like" data-show-faces="true" data-send="true"></div>
                </div>
                <hr>
                <div class="media">
                    @if($thread->img)

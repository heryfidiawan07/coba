  ...
  <blockquote class="navbar navbar-inverse navbar-static-bottom" style="margin-bottom: 0; border-radius: 0;">
    <div class="row">
      <div class="col-md-6">
        <div class="media">
      ...
      <div class="col-md-6">
        <div class="text-center">
            <li class="fotli">
              <a href="https://web.facebook.com/fidawadiskusi/"><img id="icon" src="/background/fbc.svg"> Facebook</a>
            </li>
            <li class="fotli">
